  ...
  <div class="relative">
    ...
    <Transition name="fade">
      <div 
        ...
        class="absolute top-full left-0 right-0 mt-2 bg-bd-bg-secondary border border-bd-border-default rounded-xl shadow-lg overflow-hidden" style="z-index: var(--bd-z-dropdown)"
      >
        <!-- Recent Searches -->
        ...
        <!-- Suggestions -->
        <div v-if="suggestions.length > 0" class="p-2 border-t border-bd-border-subtle">
