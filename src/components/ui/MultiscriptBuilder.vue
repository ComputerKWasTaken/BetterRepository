...
const generatedFiles = computed(() => {
  ...
  libraryParts.push('      const result = fn(hook, globalThis.text, globalThis.stop);')
  libraryParts.push('      if (typeof result === "string") {')
  libraryParts.push('        globalThis.text = result;')
  libraryParts.push('      } else if (Array.isArray(result)) {')
  libraryParts.push('        if (typeof result[0] === "string") globalThis.text = result[0];')
  libraryParts.push('        if (result[1] === true) globalThis.stop = true;')
  libraryParts.push('      } else if (result && typeof result === "object") {')
  libraryParts.push('        if (typeof result.text === "string") globalThis.text = result.text;')
  libraryParts.push('        if (result.stop === true) globalThis.stop = true;')
  libraryParts.push('      }')
  libraryParts.push('    }')
  libraryParts.push('  }')
  libraryParts.push('};')
  ...
  const makeLifecycleFile = (hookName) => {
    const returnLine = hookName === 'output'
