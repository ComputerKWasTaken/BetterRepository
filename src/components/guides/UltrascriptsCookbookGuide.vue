...
const patterns = [
  ...
  },
  {
    ...
    summary: 'Reserved for the rebuilt AI module.',
    guidance: 'For now, check <code>ai.status</code> and branch on <code>reason === "ai_module_rebuild"</code>.',
  ...
  },
  {
    ...
    summary: 'Deferred until the AI module rebuild has a generation backend.',
    guidance: 'Keep extraction logic script-side or postpone this pattern until a new AI contract is published.',
    link: '/ultrascripts?tab=ai',
    module: 'AI'
  },
  {
...
const sourceLinks = [
  ...
  { label: 'AI module', summary: 'Status-only placeholder while the generation backend is rebuilt.', href: `${sourceBase}/modules/ai` },
