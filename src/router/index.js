...
const routes = [
  ...
  },
  {
    ...
    meta: {
      ...
      ogDescription: 'BetterDungeon\'s shipped scripting platform: widgets, WebFetch, Provider AI, Clock, Geolocation, Weather, Network, System, and SDK modules over a unified Story Card runtime.',
      path: '/ultrascripts'
    }
  },
  {
