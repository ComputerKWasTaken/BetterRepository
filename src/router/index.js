...
const routes = [
  ...
  },
  {
    ...
    meta: {
      ...
      description: 'Comprehensive guides for AI Dungeon covering AI Instructions, Plot Components, Story Cards, Scripts, Symbols & Commands, Frontier, and Advanced Settings.',
      ogTitle: 'Guides - BetterRepository',
      ogDescription: 'Everything you need to master AI Dungeon. In-depth guides on AI Instructions, Plot Components, Story Cards, Scripting, Frontier, Symbols & Commands, and Advanced Settings.',
      path: '/guides'
    }
  },
  {
